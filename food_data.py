...
def strip_ingredients(file_name):
    ...
    stripped_ingredients = {ingredient["description"] : 
                            {"portions": {portion["measureUnit"]["name"]: portion["gramWeight"] for portion in ingredient["foodPortions"]},
                             "nutrients" : {nutrient["nutrient"]["name"]: [nutrient["amount"],nutrient["nutrient"]["unitName"]] for nutrient in ingredient["foodNutrients"]} }
